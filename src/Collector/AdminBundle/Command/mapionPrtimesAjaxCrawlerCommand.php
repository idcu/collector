...
class mapionPrtimesAjaxCrawlerCommand extends ContainerAwareCommand
{

    protected function configure()
    {
        $this
            ->setName('collector:admin:mapion_prtimes_ajax_crawler')
...
//        http://prtimes.jp/main/html/searchrlp/release_type_id/0/company_id/6024/pagenum/2
        ...
        for ($page = 1; $page <= $pageNum; $page++) {
            //$pressList = "http://prtimes.jp/api/search_release.php?callback=addReleaseList&type=newarrival&page=2&limit=20&_=1423933238715";
